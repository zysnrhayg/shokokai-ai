...
class GetAutonum :
	...
	def insertrecordfieldautointosysrecfldauto(self,RecordID,FieldID) :                                                                                                                        
		try :                                                                                                                                                                                
			Getmaxnumvaluedao.insertrecordfieldautointosysrecfldauto("AI000000101", RecordID, FieldID, utils.date_util.getPatternDateForDb(), "", utils.date_util.getPatternDateForDb(), "");
		except Exception as e:                                                                                                                                                            
			utils.config.global_log.error("ﾚｺｰﾄﾞ定義(管理用)取得時にエラー：%s", e)                                                                                                                       
