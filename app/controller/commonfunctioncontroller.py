...
@${SpringBootPageBucket.pageMngId}_route.route("/jigyoshomeinokohokakonosodanrirekihistoryapi.do", methods=['POST'])
...
@${SpringBootPageBucket.pageMngId}_route.route("/jigyoshomeinokohokakonosodanrirekinamesapi.do", methods=['POST'])
