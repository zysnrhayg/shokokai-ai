...
class JigyoshomeinokohokakonosodanrirekinamesapiService :
	...
	def jigyoshomeinokohokakonosodanrirekinamesapi(self,jigyoshomeinokohokakonosodanrirekinamesapi_dto,jsonObj) :
		...
		try :
			...
			# prefecture_code
			api_jigyoshomeinokohokakonosodanrirekinames.prefecturecode = PREFECTURE_CODE #ArgumentGenerator 274
			#ArgumentGenerator 274
			
			# shokokai_cd
			api_jigyoshomeinokohokakonosodanrirekinames.shokokaicd = SHOKOKAI_CD #ArgumentGenerator 274
			#ArgumentGenerator 274
			
			# LIMIT
			api_jigyoshomeinokohokakonosodanrirekinames.limit = LIMIT #ArgumentGenerator 274
			#ArgumentGenerator 274
