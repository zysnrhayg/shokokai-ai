...
class JigyoshomeinokohokakonosodanrirekihistoryapiService :
	...
	def jigyoshomeinokohokakonosodanrirekihistoryapi(self,jigyoshomeinokohokakonosodanrirekihistoryapi_dto,jsonObj) :
		...
		try :
			...
			api_jigyoshomeinokohokakonosodanrirekihistory.trnreportprefecturecode = TRN_REPORT.PREFECTURE_CODE #ArgumentGenerator 274
			#ArgumentGenerator 274
			
			# trn_report.shokokai_cd
			api_jigyoshomeinokohokakonosodanrirekihistory.trnreportshokokaicd = TRN_REPORT.SHOKOKAI_CD #ArgumentGenerator 274
			#ArgumentGenerator 274
			
			# trn_report.business_name
			api_jigyoshomeinokohokakonosodanrirekihistory.trnreportbusinessname = TRN_REPORT.BUSINESS_NAME #ArgumentGenerator 274
			#ArgumentGenerator 274
			
			# LIMIT
			api_jigyoshomeinokohokakonosodanrirekihistory.limit = LIMIT #ArgumentGenerator 274
			#ArgumentGenerator 274
