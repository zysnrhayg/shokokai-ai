...
# 関数定義_SQL文_過去の相談履歴
    ...
    def api_jigyoshomeinokohokakonosodanrirekihistory(self,dtoObj) :
        returnVal = utils.mysqldb_utils.querySQL(api_jigyoshomeinokohokakonosodanrirekihistoryMapper.api_jigyoshomeinokohokakonosodanrirekihistory(dtoObj.trn_report_prefecture_code,dtoObj.trn_report_shokokai_cd,dtoObj.trn_report_business_name,dtoObj.limit),{'trn_report_prefecture_code':dtoObj.trn_report_prefecture_code,'trn_report_shokokai_cd':dtoObj.trn_report_shokokai_cd,'trn_report_business_name':dtoObj.trn_report_business_name,'limit':dtoObj.limit})
