...
# 関数定義_SQL文_DashboardHeatm2
    ...
    def api182_dashboardheatmapcelltoggle(self,dtoObj) :
        returnVal = utils.mysqldb_utils.querySQL(api182_dashboardheatmapcelltoggleMapper.api182_dashboardheatmapcelltoggle(dtoObj.cell_key,dtoObj.excluded),{'cell_key':dtoObj.cell_key,'excluded':dtoObj.excluded})
