...
class Api144InsertknowledgeentryDto(BaseEntity):
		
	def __init__(self,mode,actflg,triggerid,row,knowledgeentryid,knowledgecode,title,prefecturecode,theme,knowledgedocumentid,status,body,createdby,updatedby):
	...
	def dict_to_json(dict):
		return Api144InsertknowledgeentryDto(dict.get("mode",""),dict.get("actflg",""),dict.get("triggerid",""),dict.get("row",""),dict.get("knowledgeentryid",""),dict.get("knowledgecode",""),dict.get("title",""),dict.get("prefecturecode",""),dict.get("theme",""),dict.get("knowledgedocumentid",""),dict.get("status",""),dict.get("body",""),dict.get("createdby",""),dict.get("updatedby",""))
