...
class Api175EntryforminitDto(BaseEntity):
		
	def __init__(self,mode,actflg,triggerid,row,documentcode,title):
	...
	def dict_to_json(dict):
		return Api175EntryforminitDto(dict.get("mode",""),dict.get("actflg",""),dict.get("triggerid",""),dict.get("row",""),dict.get("documentcode",""),dict.get("title",""))
