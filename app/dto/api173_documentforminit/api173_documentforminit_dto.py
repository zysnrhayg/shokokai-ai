...
class Api173DocumentforminitDto(BaseEntity):
	...
	def dict_to_json(dict):
		return Api173DocumentforminitDto(dict.get("mode",""),dict.get("actflg",""),dict.get("triggerid",""),dict.get("row",""),dict.get("collectioncode",""),dict.get("name",""))
