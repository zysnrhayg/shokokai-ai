...
class JigyoshomeinokohokakonosodanrirekinamesapiDto(BaseEntity):
	...
	def __init__(self,mode,actflg,triggerid,row,xx,prefecturecode,shokokaicd,limit):
	...
	def dict_to_json(dict):
		return JigyoshomeinokohokakonosodanrirekinamesapiDto(dict.get("mode",""),dict.get("actflg",""),dict.get("triggerid",""),dict.get("row",""),dict.get("xx",""),dict.get("prefecturecode",""),dict.get("shokokaicd",""),dict.get("limit",""))
