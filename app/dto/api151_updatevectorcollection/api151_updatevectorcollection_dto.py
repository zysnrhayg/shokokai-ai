...
class Api151UpdatevectorcollectionDto(BaseEntity):
	...
	def __init__(self,mode,actflg,triggerid,row,name,status,vectorcollectionid):
	...
	def dict_to_json(dict):
		return Api151UpdatevectorcollectionDto(dict.get("mode",""),dict.get("actflg",""),dict.get("triggerid",""),dict.get("row",""),dict.get("name",""),dict.get("status",""),dict.get("vectorcollectionid",""))
