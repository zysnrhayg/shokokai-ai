...
class Api107InserttrusteddeviceDto(BaseEntity):
		
	def __init__(self,mode,actflg,triggerid,row,useraccountid,tokenhash,expiresat):
	...
	def dict_to_json(dict):
		return Api107InserttrusteddeviceDto(dict.get("mode",""),dict.get("actflg",""),dict.get("triggerid",""),dict.get("row",""),dict.get("useraccountid",""),dict.get("tokenhash",""),dict.get("expiresat",""))
