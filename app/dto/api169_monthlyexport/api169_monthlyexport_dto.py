...
class Api169MonthlyexportDto(BaseEntity):
		
	def __init__(self,mode,actflg,triggerid,row,result,formcode,fiscalyearcode):
	...
	def dict_to_json(dict):
		return Api169MonthlyexportDto(dict.get("mode",""),dict.get("actflg",""),dict.get("triggerid",""),dict.get("row",""),dict.get("result",""),dict.get("formcode",""),dict.get("fiscalyearcode",""))
