...
class GetthemegroupsDto(BaseEntity):
		
	def __init__(self,mode,actflg,triggerid,row,filtergroup,filtergrouplabel):
		super().__init__(mode,actflg,triggerid,row)
			#filter_group
		self.filtergroup = filtergroup
			#filter_group_label
		self.filtergrouplabel = filtergrouplabel
	
	def dict_to_json(dict):
		return GetthemegroupsDto(dict.get("mode",""),dict.get("actflg",""),dict.get("triggerid",""),dict.get("row",""),dict.get("filtergroup",""),dict.get("filtergrouplabel",""))
