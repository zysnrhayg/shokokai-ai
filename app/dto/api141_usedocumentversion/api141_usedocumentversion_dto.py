...
class Api141UsedocumentversionDto(BaseEntity):
		
	def __init__(self,mode,actflg,triggerid,row,versionnumber,knowledgedocumentid):
	...
	def dict_to_json(dict):
		return Api141UsedocumentversionDto(dict.get("mode",""),dict.get("actflg",""),dict.get("triggerid",""),dict.get("row",""),dict.get("versionnumber",""),dict.get("knowledgedocumentid",""))
