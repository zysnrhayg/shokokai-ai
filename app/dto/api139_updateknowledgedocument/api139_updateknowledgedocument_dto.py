...
class Api139UpdateknowledgedocumentDto(BaseEntity):
		
	def __init__(self,mode,actflg,triggerid,row,title,prefecturecode,category,format,updatedby,knowledgedocumentid):
	...
	def dict_to_json(dict):
		return Api139UpdateknowledgedocumentDto(dict.get("mode",""),dict.get("actflg",""),dict.get("triggerid",""),dict.get("row",""),dict.get("title",""),dict.get("prefecturecode",""),dict.get("category",""),dict.get("format",""),dict.get("updatedby",""),dict.get("knowledgedocumentid",""))
