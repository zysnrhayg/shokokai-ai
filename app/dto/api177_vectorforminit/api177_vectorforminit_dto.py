...
class Api177VectorforminitDto(BaseEntity):
	...
	def dict_to_json(dict):
		return Api177VectorforminitDto(dict.get("mode",""),dict.get("actflg",""),dict.get("triggerid",""),dict.get("row",""),dict.get("vectorcollectionid",""),dict.get("name",""),dict.get("vectorcount",""),dict.get("synceddate",""),dict.get("status",""))
