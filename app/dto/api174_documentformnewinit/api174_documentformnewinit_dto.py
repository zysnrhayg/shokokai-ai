...
class Api174DocumentformnewinitDto(BaseEntity):
		
	def __init__(self,mode,actflg,triggerid,row,collectioncode,name):
	...
	def dict_to_json(dict):
		return Api174DocumentformnewinitDto(dict.get("mode",""),dict.get("actflg",""),dict.get("triggerid",""),dict.get("row",""),dict.get("collectioncode",""),dict.get("name",""))
